...
$inputPath = Read-Host "Enter Path to Store Your Download (Press Enter for Default)"

  if ([string]::IsNullOrWhiteSpace($inputPath)) {
        $saveDir = "$env:USERPROFILE\Downloads"
        Write-Host "No path entered. Using default: $saveDir" -ForegroundColor Blue
        $validPath = $true
    } 

  elseif ($inputPath -cmatch '^[a-zA-Z]:\\[a-zA-Z0-9\\ ]*$') {
        $saveDir = $inputPath
        $validPath = $true
        Write-Host "Path Accepted: $saveDir" -ForegroundColor Green
    } 

   else {
        Write-Host "`n[!] INVALID INPUT: Please use A-Z, Numbers, and '\'." -ForegroundColor Red
        Write-Host "[!] Example: 'C:\Users\Tom\Downloads'`n" -ForegroundColor Yellow
    }
...
#Format selections
if ($choice -eq "1") {
    . "$PSScriptRoot\FormatSelections\VideoSelections.ps1"

} elseif ($choice -eq "2") {
    . "$PSScriptRoot\FormatSelections\AudioSelections.ps1"
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUY9Kt6UEubHVjYNJjk1gaGi/h
# stmgghZEMIIDBjCCAe6gAwIBAgIQGHw5nsO4t6hG7rb6YvPp6DANBgkqhkiG9w0B
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQPFBOW1TBuV3iHkyBnw37G9NpC3DANBgkq
# hkiG9w0BAQEFAASCAQA14ikrZ/LeM+yeSP47+Oa3Qjtxv2YvZV/1zmTFAKUhtJVJ
# FyGMNbAT8HRPBDW8sHMz5BgTG0QaU0QQqbInw/fRsbIs4s4R6mlJC4//xc3pbsXT
# 2TMoMpSTw9B5zdnMXtlaWfHQfiY1aj140JCARp9Q4/xRC9EiiTV/u+PN2mtQ7qxE
# ZCWdW+S6YILi3s9E8DL42rRErlddmDUllzQ5rE4xKiHNqo9MkGBM2/1od+VT1bG8
# ErSWrsehUyN8783Fn+u46YwNU/xO3ypgTBDFtTd4bfnaV1b2J2M23T251axnUdQ8
# i3sREIVmujGWqDsLO15KU3RWgEIDoS90vIkm2mTwoYIDJjCCAyIGCSqGSIb3DQEJ
...
# AQkFMQ8XDTI2MDEwNzAxNTY0NVowLwYJKoZIhvcNAQkEMSIEIPNBfuapcduid43u
# 2H4WMWHk7ZGy0gbzlHnjJhWc808LMA0GCSqGSIb3DQEBAQUABIICAJA02OEpNgyV
# eNGJTXuy82hFUlgITOBEQfznzgl7ksyakcuhxizb6DR4LQyb3BipS7VHVn6B/4HJ
# zupnzos2AoRvy4FcqUeZps9VRGc+bJdNbOx2kYaCFI4p+TxgDcMaza5qhL9xR6tr
# ZRxxyI3j/z4UCZ6BarEkUupRDH4TprZTOfFnatoxSdYSn/KswVgiDy+xa2e2H6rk
# SLRlpMH+rx0YRzxNxwXXS+p+QcOJIy94sgx+/5ks6fX0ObrQWkBELC5UGY3AVDpT
# vJVNgsmWwnoe+2rAmbUK3VjAx5CmqWj/CDSyl0YIH3qFW5EizxJVYiZm6e7f23pt
# OM3pm3jIMhfz6DR3g72Bp4eo5o53o6BPbn/3OfahqdMBQYLE5j/HWRcw3+QETmqr
# jxLerqYB/ZLiT0gmQ7u6j0mRnmLaO1CVzrX4pg4bkQpoMNM+rtn5spG04YcXCfOL
# idE6jTUkgjlsjFruGvGVo44ni9MSIGgiMCGfRcpS+35hvQDORy/0ZIgfPfHMNeHI
# SUg4Y47B7CvKXPt/hTVaFbvRYaAsp6c7F1RxDkHtHtg+a975XB1XEe+2xo1r9Q70
